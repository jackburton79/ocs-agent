...
bool
InventoryFormat::Build(bool noSoftware)
{
	try {
		// TODO: For glpi only
...
bool
InventoryFormat::Save(const char* fileName)
{
	if (fileName == NULL)
		return false;
...
bool
InventoryFormat::Send(const char* serverUrl)
{
...
int
InventoryFormat::Checksum() const
{
...
// Private
void
InventoryFormat::_AddAccountInfo()
{
...
void
InventoryFormat::_AddStoragesInfo()
{
...
void
InventoryFormat::_AddMemoriesInfo()
{
	int slotNum = 0;
	for (;;) {
		std::ostringstream s;
...
void
InventoryFormat::_AddDrivesInfo()
{
...
void
InventoryFormat::_AddNetworksInfo()
{
	NetworkRoster roster;
	NetworkInterface interface;
	unsigned int cookie = 0;
...
void
InventoryFormat::_AddProcessesInfo()
{
...
void
InventoryFormat::_AddSoftwaresInfo()
{
	Softwares softwares;
	software_info info;
...
void
InventoryFormat::_AddVideosInfo()
{
...
void
InventoryFormat::_AddMonitorsInfo()
{
	Screens screens;
	screen_info info;
...
bool
InventoryFormat::_WriteProlog(tinyxml2::XMLDocument& document) const
{
...
std::string
InventoryFormat::GenerateDeviceID() const
{
	// Try system UUID.
